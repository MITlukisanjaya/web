...
@foreach($lesson->data as $key => $data)
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="col-sm-6 col-md-8">
                ...
                <h4><a href="{{ route('front.lesson.detail', ['lesson' => $data->slug]) }}">{{ $data->title }}</a></h4>

                @foreach ($data->categories as $q => $category)
                    <span class="badge badge-pill badge-default">
                        <a href="{{ route('front.lesson.by.category', ['lesson' => $category->category->slug]) }}" style="color: #fff;">{{$category->category->category}}</a>
                    </span>
                ...
                <a href="{{ route('front.lesson.detail', ['lesson' => $data->slug]) }}" class="btn btn-default btn-sm float-right">More ... </a>
                <section>
